...
const PATHS = {
  ...
  code: `<rect x="3" y="4.5" width="18" height="15" rx="3" ${F}/><path d="m9.5 9.5-2.5 2.5 2.5 2.5M14.5 9.5l2.5 2.5-2.5 2.5" />`,
  x: `<path d="M4 4l6.6 8.8L4.2 20h1.9l5.3-6 4.5 6H20l-6.9-9.2L19.1 4h-1.9l-4.8 5.5L8.2 4z" fill="currentColor" stroke="none"/>`,
